const translations = {
  uk: {
    ...
    validationFailed:
      'Виявлено помилки у файлі',

    validationFileReady:
      'Згенеровано файл з підсвіченими помилками',
    ...
    helpStep1:
      'Завантаж CSV або Excel файл із MGRS координатами та value.',

    helpStep2:
      'Натисни кнопку "Обробити".',

    helpStep3:
      'Якщо знайдено помилки — буде згенеровано Excel файл із підсвіченими рядками.',

    helpStep4:
      'Виправ помилки та завантаж файл повторно.',

    helpStep5:
      'При успішній обробці буде згенеровано CSV файл у форматі latitude,longitude,value.',

    helpStep6:
      'На мапі доступний preview у режимі точок або heatmap.'
  },
  ...
  en: {
    ...
    validationFileReady:
      'Generated file with highlighted errors',
    ...
    excelNoSheets:
      'Excel file does not contain sheets',
    ...
    valueIntegerOnly:
      'Value must be an integer only',

    mgrsDigitsError:
      'MGRS must contain exactly 10 digits after zone and grid square',

    invalidCoordinateStructure:
      'Invalid coordinate structure',

    invalidCoordinateValues:
      'Coordinates contain invalid values',

    unknownError:
      'Unknown error',

    mgrsWrongDigits:
      'Wrong number of digits in MGRS coordinate',
    ...
    helpStep1:
      'Upload CSV or Excel file with MGRS coordinates and value.',

    helpStep2:
      'Press the "Process" button.',

    helpStep3:
      'If errors are found, an Excel file with highlighted rows will be generated.',

    helpStep4:
      'Fix the errors and upload the file again.',

    helpStep5:
      'After successful processing, CSV file in latitude,longitude,value format will be generated.',

    helpStep6:
      'Map preview is available in points or heatmap mode.'
  }
};
